...
[ -f "$CLAUDE_DIR/commands/menu.md" ] && EXISTING_INSTALL="yes"
[ -f "$CLAUDE_DIR/hooks/capstone-test-runner.sh" ] && EXISTING_INSTALL="yes"
[ -f "$CLAUDE_DIR/hooks/session-greeting.sh" ] && EXISTING_INSTALL="yes"
[ -f "$CLAUDE_DIR/hooks/compact-recovery.sh" ] && EXISTING_INSTALL="yes"
...
echo "  tutorial.md"
cp "$SCRIPT_DIR/commands/menu.md" "$CLAUDE_DIR/commands/menu.md"
echo "  menu.md"
...
cp "$SCRIPT_DIR/hooks/session-greeting.sh" "$CLAUDE_DIR/hooks/session-greeting.sh"
chmod +x "$CLAUDE_DIR/hooks/session-greeting.sh"
echo "  session-greeting.sh"
cp "$SCRIPT_DIR/hooks/compact-recovery.sh" "$CLAUDE_DIR/hooks/compact-recovery.sh"
chmod +x "$CLAUDE_DIR/hooks/compact-recovery.sh"
